  ...
  constructor(
    ...
    this.userProfileService.getUserProfile(this.user_id).subscribe(profiles=>{
      ...
      this.profile_form = this.formBuilder.group({
        title: [this.user_profile[0]["title"], Validators.required],
        first_name: [this.user_profile[0]["first_name"], Validators.required],
        second_name: [this.user_profile[0]["second_name"], Validators.required],
        role: [this.user_profile[0]["role"], Validators.required],
        secondary_role: [this.user_profile[0]["secondary_role"], Validators.required],
        mobile: [this.user_profile[0]["mobile"], Validators.required],
        email: [this.user_profile[0]["email"], Validators.required],
        bio: [this.user_profile[0]["bio"], Validators.required]
      });
    });
  }
